...
$sWhere_v1 = "WHERE item_condition = 'Ok'";
$sWhere_v2 = " AND WHERE item_condition = 'Ok'";

$sWhere_v1 = "WHERE post_id IN " . $post_id_array_str . "AND item_condition = 'Ok'";
$sWhere_v2 = " AND WHERE post_id IN " . $post_id_array_str . "AND item_condition = 'Ok'";
