...
$sWhere_v1 = "WHERE post_id IN " . $post_id_array_str . "AND item_condition = 'Acceptable'";
$sWhere_v2 = " AND WHERE post_id IN " . $post_id_array_str . "AND item_condition = 'Acceptable'";
